...
/**
 * Stratégie pour les projets en Vertigo Domino.
 */
public final class VertigoDominoStrategy implements LegacyStrategy {

	@Override
	public KspDeclarationParts getKspDeclarationParts(String lineContent) {
		KspDeclarationMainParts mainParts = KspStringUtils.getVertigoDominoKspDeclarationParts(lineContent);
		if (mainParts == null) {
			return null;
		}
	...
	public KspAttribute getKspAttribute(String lineContent) {
		// TODO
		return KspStringUtils.getVertigoKspAttribute(lineContent);
	}
